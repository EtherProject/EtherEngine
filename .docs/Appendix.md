...
| EVENT_KEYDOWN_RIGHTPAREN            | 事件：按下键位 右PAREN（右圆括号）              |
...
| EVENT_KEYUP_PRINTSCREEN           | 事件：松开键位 PRINTSCREEN（截屏）             |
